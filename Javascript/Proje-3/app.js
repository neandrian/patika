...
let listDOM = document.querySelector("#menu");

function loadData(menu) {
  listDOM.innerHTML = "";
  menu.forEach((element) => {
    let liDOM = document.createElement("div");
    liDOM.classList.add("menu-items", "col-lg-6", "col-sm-12");
    liDOM.innerHTML = `<img src="${element.img}" alt="${element.title}" class="photo" />
    <div class="menu-info">
...
function changeCategory(category) {
  if (category === "All") {
    ...
    const filteredMenu = menu.filter((element) => element.category === category);
